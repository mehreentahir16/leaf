...
class Server:
    ...
    def get_clients_info(self, clients):
        ...
        return ids, groups, num_samples, hardware_scores, network_scores, data_quality_scores, costs, losses, gradient_magnitudes, gradient_variances, update_weights
